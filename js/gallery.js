...
const GALLERY_ITEMS = [
  ...
  { file: 'assets/gallery/after-everyone-sleeps.png',  label: 'AFTER EVERYONE SLEEPS',       placeholder: '◈', tags: ['artwork'] },
  { file: 'assets/gallery/echoes-of-yesterday.png',    label: 'ECHOES OF YESTERDAY',         placeholder: '◈', tags: ['artwork'] },
  { file: 'assets/gallery/letters-i-ve-never-send.png', label: 'LETTERS I\'VE NEVER SEND',     placeholder: '◈', tags: ['artwork'] },
